...
function inflateInit2_(var z: z_stream;
                       ...
                       stream_size : int) : int;
begin
  if (version = '') or (System.Copy(version, 1, 1) <> System.Copy(String(ZLIB_VERSION), 1, 1)) or
...
begin
  inflateInit2 := inflateInit2_(z, windowBits, String(ZLIB_VERSION), sizeof(z_stream));
end;
...
begin
  inflateInit := inflateInit2_(z, DEF_WBITS, String(ZLIB_VERSION), sizeof(z_stream));
end;
